package es.isaias.springboot.reuniones.async;
...
import es.isaias.springboot.reuniones.services.PersonaService;
...
public class BuscaListener {
    ...
    public void recibirMensaje(String mensaje) {
        try {
            ...
            if (reunion.isEmpty()) {
                LOG.warn("Mensaje recibido, pero la reunion {} no existe",
                        info.getIdReunion());
            }
